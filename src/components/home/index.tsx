  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image src={HomePageGraphic} alt='home-pageGraphic' />
        </div>
      </motion.div>
        ...
        >
          ...
          >
            <div className='flex w-3/5 items-center justify-between gap-8'>
              <Image src={SponsorRedBull} alt="redbull-sponsor"/>
              <Image src={SponsorForbes} alt="forbes-sponsor"/>
              <Image src={SponsorFortune} alt="fortune-sponsor"/>
            </div>
          </div>
        </div>
      )}
